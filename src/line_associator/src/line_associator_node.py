...
class LineAssociatorNode(object):

    def __init__(self):
        self.node_name="LineAssociatorNode"
        self.active = True
    ...
    def onShutdown(self):
        rospy.loginfo("[LineAssociatorNode] Shutdown.")

if __name__ == '__main__':
    rospy.init_node('line_associator',anonymous=False)
    line_associator_node = LineAssociatorNode()
    rospy.on_shutdown(line_associator_node.onShutdown)
    rospy.spin()
